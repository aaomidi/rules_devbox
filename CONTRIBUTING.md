...
some other ruleset that depends on rules_devbox, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_devbox=$(pwd)/rules_devbox"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_devbox` on your system will point to this folder.
