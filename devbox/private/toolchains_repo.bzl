...
# By default all these toolchains are registered by the devbox_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:devbox_toolchain",
    toolchain_type = "@com_aaomidi_rules_devbox//devbox:toolchain_type",
)
""".format(
            platform = platform,
