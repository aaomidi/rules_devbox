...
def _devbox_toolchain_impl(ctx):
...
devbox_toolchain = rule(
    implementation = _devbox_toolchain_impl,
    attrs = {
    ...
    doc = """Defines a devbox compiler/runtime toolchain.
